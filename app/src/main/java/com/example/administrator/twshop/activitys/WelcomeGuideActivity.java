...
import com.example.administrator.twshop.adapter.GuideViewPagerAdapter;
...
public class WelcomeGuideActivity extends Activity implements OnClickListener {
    ...
    protected void onPause() {
        ...
        PublicUtils.putBoolean(WelcomeGuideActivity.this, Constants.FIRST_OPEN, true);
        finish();
    }
